    ...
    <div>
      ...
      <div className="sect">
        ...
        <p><em>
          ...
          more. Check out our new products and special offers below!!!</em>
        </p>

        <strong>
          FREE Shipping on orders above 500kr. Shipping charge is 49kr. on orders below
          500kr. Shipping on ALL ORDERS to local areas around Copenhagen.
        </strong>
      </div>
      <PopularProductList />
    </div>
